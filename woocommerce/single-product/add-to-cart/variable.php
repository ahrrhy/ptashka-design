	...
	<?php else : ?>
        <table class="variations" cellspacing="0">
            ...
            foreach ( $attributes as $attribute_name => $options ) : ?>
                ...
                <tr class="variable-tr" id="<?php echo "variable-tr"?>">
                    <td class="label">
...
//                            echo end( $attribute_keys ) === $attribute_name ? apply_filters(
...
//                            ) : '';
            ...
            <?php
            if (stripos($attribute_name, 'invitation')) : ?>
                <tr class='product_additional_data'><td>
                        <?php the_field('invitation_additional_data'); ?>
                    </td></tr>
           <?php else : ?>
                <tr class='product_additional_data'><td>
                        <?php the_field('envelope_additional_data'); ?>
                    </td></tr>
            <?php endif;
            endforeach;?>
            </tbody>
